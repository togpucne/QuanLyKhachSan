                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="../controller/user.controller.php?action=doRegister">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel"
                                class="form-control rounded-3 <?php echo isset($errors['phone']) ? 'is-invalid' : ''; ?>"
                                id="phone"
                                name="phone"
                                value="<?php echo isset($oldInput['phone']) ? htmlspecialchars($oldInput['phone']) : ''; ?>"
...
<script>
    ...
    document.getElementById('phone').addEventListener('input', function(e) {
        ...
        const phoneRegex = /^(03|05|07|08|09)[0-9]{0,8}$/;
